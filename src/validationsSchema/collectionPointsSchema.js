...
const latitudeSchema = z.string().min(-90).max(90).describe("A latitude deve estar entre -90 e 90");
const longitudeSchema = z.string().min(-180).max(180).describe("A longitude deve estar entre -180 e 180");
